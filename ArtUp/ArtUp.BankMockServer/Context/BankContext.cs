...
namespace ArtUp.BankMockServer.Context
{
    ...
    public class StoreDbInitializer : DropCreateDatabaseIfModelChanges<BankContext>
    {
        protected override void Seed(BankContext db)
        {
            ...
            db.Accounts.Add(new Account { Id = 5, Nubmer = "9999999999991", FaceType = Enums.FaceType.Individual, FirstName = "Personal", LastName = "ArtUp", PatronomicName = "", Adress = "Minsk", Money = 0, Type = Enums.AccountType.Saving });
